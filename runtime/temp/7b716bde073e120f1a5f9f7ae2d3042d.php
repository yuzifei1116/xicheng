<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:78:"D:\phpstudy_pro\WWW\xicheng/application/admin/view/menu/menu_comment/index.php";i:1605513105;s:71:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\container.php";i:1605513105;s:72:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\frame_head.php";i:1605513105;s:67:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\style.php";i:1605513105;s:74:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\frame_footer.php";i:1605513105;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"<?php echo Url('comment_list'); ?>",function (){
        return [
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            case 'delstor':
                var url=layList.U({c:'menu.menu_comment',a:'delete',q:{id:data.id}});
