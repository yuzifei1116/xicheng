<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:83:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng/application/admin/view/user/user/index.php";i:1600141545;s:84:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\container.php";i:1579139306;s:85:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\frame_head.php";i:1579139306;s:80:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\style.php";i:1579139306;s:87:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\frame_footer.php";i:1579139306;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    <div class="layui-btn-group conrelTable">
                        <button class="layui-btn layui-btn-sm layui-btn-normal" type="button" data-type="coupon"><i class="fa fa-check-circle-o"></i>发送优惠券</button>
...
<script>
    ...
    layList.tableList('userList',"<?php echo Url('get_user_list'); ?>",function () {
        return [
                ...
                {field: 'avatar', title: '头像', event:'open_image', width: '10%', templet: '<p><img class="avatar" style="cursor: pointer" class="open_image" data-image="{{d.avatar}}" src="{{d.avatar}}" alt="{{d.nickname}}"></p>'},
                {field: 'nickname', title: '姓名',templet:'#nickname'},
                // {field: 'now_money', title: '余额',width:'10%',sort:true,event:'now_money'},
                // {field: 'pay_count', title: '购买次数',align:'center',width:'6%'},
                // {field: 'extract_count_price', title: '累计提现',align:'center',width:'6%'},
                {field: 'integral', title: '积分',width:'10%',sort:true,event:'integral'},
...
//    layList.sort('uid');
    ...
    var action={
        ...
        coupon:function () {
            ...
            if(ids.length){
                var str = ids.join(',');
                $eb.createModalFrame('发送优惠券',layList.Url({c:'coupon.coupon',a:'send_coupon',p:{id:str}}),{'w':800});
            }else{
