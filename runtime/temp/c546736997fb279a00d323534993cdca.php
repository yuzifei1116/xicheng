<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng/application/admin/view/store/store_product/attr.php";i:1605348498;s:79:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\head.php";i:1579139306;s:80:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\style.php";i:1579139306;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
            ...
            methods: {
                ...
                createFrame:function(title,src,opt){
                    ...
                    return layer.open({
                        type: 2,
                        title:title,
                        area: ['80%','80%'],//[(opt.w || 700)+'px', (opt.h || 650)+'px'],
                        fixed: false, //不固定
                        maxmin: true,
