<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:70:"D:\phpstudy_pro\WWW\xicheng/application/admin/view/menu/menu/index.php";i:1605513105;s:71:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\container.php";i:1605513105;s:72:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\frame_head.php";i:1605513105;s:67:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\style.php";i:1605513105;s:74:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\frame_footer.php";i:1605513105;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-container">
                        <button type="button" class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('create'); ?>')">添加菜品</button>
                    </div>
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"<?php echo Url('menu_list'); ?>",function (){
        return [
            {field: 'id', title: 'ID', sort: true,event:'id',width:'6%'},
            {field: 'cate_title', title: '分类名称',width:'10%'},
            {field: 'menu_title', title: '菜品名称'},
            {field: 'image', title: '图片',templet:'#image',width:'10%'},
