<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:78:"D:\phpstudy_pro\WWW\xicheng/application/admin/view/order/store_order/index.php";i:1605513105;s:71:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\container.php";i:1605513105;s:72:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\frame_head.php";i:1605513105;s:67:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\style.php";i:1605513105;s:74:"D:\phpstudy_pro\WWW\xicheng\application\admin\view\public\frame_footer.php";i:1605513105;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('修改订单','<?php echo Url('edit'); ?>?id={{d.id}}')">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('订单记录','<?php echo Url('order_status'); ?>?oid={{d.id}}')">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a  href="javascript:void(0);" onclick="$eb.createModalFrame('去送货','<?php echo Url('delivery'); ?>?id={{d.id}}',{w:400,h:300})">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('退款','<?php echo Url('refund_y'); ?>?id={{d.id}}',{w:400,h:300})">
                                    <i class="fa fa-history"></i> 立即退款
                                </a>
                            </li>
                            {{#  }else if(d.use_integral > 0 && d.use_integral >= d.back_integral){ }}
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('退积分','<?php echo Url('integral_back'); ?>?id={{d.id}}')">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('退积分','<?php echo Url('integral_back'); ?>?id={{d.id}}',{w:400,h:300})">
                                    <i class="fa fa-history"></i> 退积分
                                </a>
                            </li>
                            {{#  };}}
                            ...
                            {{# } ;}}
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('不退款','<?php echo Url('refund_n'); ?>?id={{d.id}}',{w:400,h:300})">
                        ...
                        {{#  }else if(d._status==4){ }}
                        <button class="btn btn-default btn-xs" type="button" onclick="$eb.createModalFrame('配送信息','<?php echo Url('distribution'); ?>?id={{d.id}}')">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            {{#  if(parseFloat(d.pay_price) > parseFloat(d.refund_price)){ }}
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('退款','<?php echo Url('refund_y'); ?>?id={{d.id}}')">
                                    <i class="fa fa-history"></i> 立即退款
                                </a>
                            </li>
                            {{# }else if(d.use_integral > 0 && d.use_integral >= d.back_integral){ }}
...
<script>
    layList.tableList('List',"<?php echo Url('order_list',['real_name'=>$real_name]); ?>",function (){
        return [
            ...
            {field: 'paid', title: '支付状态',templet:'#paid',width:'11%'},
