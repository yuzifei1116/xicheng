<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng/application/admin/view/ad/ad/create.php";i:1600324759;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    layui.use(['form','laydate','upload','colorpicker'], function(){
        ...
        form.on('submit(demo1)', function(data){
            ...
            $.ajax({
                type:"post",
                url:"<?php echo url('admin/ad.ad/save'); ?>",
                data:data.field,
                dataType:"json",
