<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:88:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng/application/admin/view/stay/stay_info/index.php";i:1600502168;s:84:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\container.php";i:1579139306;s:85:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\frame_head.php";i:1579139306;s:80:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\style.php";i:1579139306;s:87:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\frame_footer.php";i:1579139306;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="number" value="<?php echo $number; ?>" class="layui-input" placeholder="请输入房间号">
                                </div>
                            </div>
                            <div class="layui-inline">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="info">
                        <a href="javascript:void(0)" onclick="$eb.createModalFrame('入住信息','<?php echo Url('stay_info'); ?>?id={{d.id}}')">查看</a>
                    </script>
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"<?php echo Url('info_list'); ?>",function (){
        return [
