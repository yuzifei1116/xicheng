<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng/application/admin/view/index/index.php";i:1599879164;s:80:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\style.php";i:1579139306;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element admin_open">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li><a class="admin_close" target="_blank" href="www.baidu.com">联系我们</a>
                            </li>
                            <li class="divider"></li>
...
<!--            <a href="javascript:void(0);" class="roll-nav roll-right J_tabRefresh" title="刷新"><i class="fa fa-refresh"></i> </a>-->
            <a href="javascript:void(0);" onclick="window.frames[$('.page-tabs-content .active').index()].location.reload();window.frames[$('.page-tabs-content .active').index()+1].location.reload();" class="roll-nav roll-right J_tabRefresh" title="刷新"><i class="fa fa-refresh"></i> </a>
