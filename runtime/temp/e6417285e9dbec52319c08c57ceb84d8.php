<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:99:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng/application/admin/view/store/store_product_reply/index.php";i:1592193758;s:84:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\container.php";i:1579139306;s:85:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\frame_head.php";i:1579139306;s:80:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\style.php";i:1579139306;s:87:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\frame_footer.php";i:1579139306;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    搜索条件
                    <a href="javascript:history.go(-1)" class="layui-btn layui-btn-sm" style="float:right">返回</a>
                </div>
        ...
        new Vue({
            ...
            data: {
                ...
                where:{
                    ...
                    is_reply:'',
                    limit:10,
                    producr_id:<?php echo $where['product_id']; ?>,
                    message_page:1,
                },
                product:{
                    loading:false,
