<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng/application/admin/view/ad/ad/index.php";i:1600324799;s:84:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\container.php";i:1579139306;s:85:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\frame_head.php";i:1579139306;s:80:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\style.php";i:1579139306;s:87:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\frame_footer.php";i:1579139306;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-container">
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('create'); ?>')">添加广告位</button>
                        <a class="layui-btn layui-btn-sm" href="<?php echo Url('index'); ?>">刷新</a>
                    </div>
                    ...
                    <script type="text/html" id="act">
                        <a href="javascript:void(0)" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('edit'); ?>?id={{d.id}}')">
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"<?php echo Url('ad_list'); ?>",function (){
        return [
