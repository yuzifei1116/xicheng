<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:95:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng/application/admin/view/setting/system_config/index.php";i:1579139306;s:84:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\container.php";i:1579139306;s:85:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\frame_head.php";i:1579139306;s:80:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\style.php";i:1579139306;s:87:"D:\phpStudy\PHPTutorial\WWW\2009_xicheng\application\admin\view\public\frame_footer.php";i:1579139306;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="tab-content">
                <div class="<!--ibox-content--> p-m m-t-sm">
                    <form method="post" class="form-horizontal" id="signupForm" action="<?php echo Url('save_basics'); ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <?php switch($vo['type']): case "text": ?><!-- 文本框-->
                                            <input type="<?php echo $vo['type']; ?>" class="form-control" name="<?php echo $vo['menu_name']; ?>" value="<?php echo $vo['value']; ?>" validate="<?php echo $vo['required']; ?>" style="width: <?php echo $vo['width']; ?>%"/>
