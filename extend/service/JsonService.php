...
class JsonService
{
    ...
    public static function successfuljson($msg = 'ok',$data=[],$status=200,$count=0)
    {
        if(false == is_string($msg)){
            $data = $msg;
            $msg = self::$SUCCESSFUL_DEFAULT_MSG;
        ...
        return self::result($status,$msg,$data,$count);
    }
    public static function failjson($msg,$data=[],$code=400)
    {
