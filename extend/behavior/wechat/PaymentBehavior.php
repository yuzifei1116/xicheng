...
use app\gzh\model\store\StoreOrder as StoreOrderGzhModel;
...
class PaymentBehavior
{
     ...
     * @return bool
     */
    public static function wechatPaySuccessProductgzh($orderId, $notify)
    {
        try{
            if(StoreOrderGzhModel::be(['order_id'=>$orderId,'paid'=>1])) return true;
            return StoreOrderGzhModel::paySuccess($orderId);
        }catch (\Exception $e){
            return false;
        }
    }
