            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-container">
                        <button type="button" class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}')">添加类型</button>
                    </div>
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"{:Url('type_list')}",function (){
        return [
