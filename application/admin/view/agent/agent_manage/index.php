                         ...
                         <?php $count = count($list); ?>
                            {if condition="$count"}
                                {volist name="list" id="vo"}
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-white  btn-xs"  onclick="$eb.createModalFrame('推荐人列表','{:Url('second',['uid'=>$vo['uid']])}',{'w':800})">
                                            <i class="fa fa-street-view"></i>
                                            {$vo.second}
                                        </button>
                                    </td>
                                    <td class="text-center">
                                        <button class="btn btn-white  btn-xs"  onclick="$eb.createModalFrame('推广订单','{:Url('order_stair',['uid'=>$vo['uid']])}',{'w':800})">
                                            <i class="fa fa-file-text-o"></i>
                                            {$vo.order_stair}
                                        </button>
                                    </td>
                                    <td class="text-center">
                                        <button class="btn btn-white  btn-xs"  onclick="$eb.createModalFrame('推广订单','{:Url('order_second',['uid'=>$vo['uid']])}',{'w':800})">
                                            <i class="fa fa-file-text-o"></i>
                                            {$vo.order_second}
                                        </button>
                                    </td>
                                    <td class="text-center">
                                        <button class="btn btn-white  btn-xs"  onclick="$eb.createModalFrame('佣金记录','{:Url('now_money_spread',['uid'=>$vo['uid']])}',{'w':800})">
