    ...
    <div class="layui-row layui-col-space15"  id="app">
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">二级推荐人列表</div>
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"{:Url('get_now_money_spread',['uid'=>$uid])}",function (){
        return [
//            {field: 'uid', title: '编号', sort: true,event:'id'},
            {field: 'number', title: '金额',width:'20%'},
            {field: 'mark', title: '记录'},
            {field: 'add_time', title: '时间',width:'20%'},
        ];
    });
    //自定义方法
    var action= {
