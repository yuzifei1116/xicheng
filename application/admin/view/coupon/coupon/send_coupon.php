                ...
                <div class="table-responsive">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-primary btn-xs grant" data-url="{:Url('coupon.coupon_use/send_coupon',array('id'=>$vo['id'],'uid'=>$uid))}" type="button"><i class="fa  fa-arrow-circle-o-right"></i> 发放
                                </button>
                            </td>
                        </tr>
                        {/volist}
