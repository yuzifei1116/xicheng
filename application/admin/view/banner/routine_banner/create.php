...
<!--        <button type="button" class="layui-btn" id="test1">上传图片</button>-->
        <div class="layui-upload-list">
            <img class="layui-upload-img img" id="demo1" width="100px" height=100px">
            <p id="demoText"></p>
    ...
    <div class="layui-form-item" style="margin-left: 42px;">
        ...
        <div class="layui-input-inline" style="width: 120px;">
            <input type="text" name="bg_color" value="#c25347" placeholder="请选择颜色" class="layui-input" id="test-form-input">
        </div>
...
<script type="text/javascript">
    layui.use(['form','laydate','upload','colorpicker'], function(){
        ...
        var uploadInst = upload.render({
            elem: '#test1'
            ,url: "{:url('admin/banner.routine_banner/upload')}" //改成您自己的上传接口
            ,before: function(obj){
                //预读本地文件示例，不支持ie8
        ...
        form.on('submit(demo1)', function(data){
            ...
            $.ajax({
                type:"post",
                url:"{:url('admin/banner.routine_banner/save')}",
                data:data.field,
                dataType:"json",
