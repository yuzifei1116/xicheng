        ...
        <form class="layui-form" action="">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="mer_name" lay-verify="required" placeholder="请输入店铺名称" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">账号</label>
                <div class="layui-input-block">
                    <input type="text" name="account" lay-verify="required" placeholder="请输入店铺账号" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">密码</label>
                <div class="layui-input-block">
                    <input type="password" name="pwd" lay-verify="pass" placeholder="请输入店铺密码,6~12位" class="layui-input">
                </div>
            </div>
            <div class="layui-upload" style="margin-left: 1px;">
                <label class="layui-form-label">logo</label>
                <div class="layui-upload-list">
                    <img class="layui-upload-img image" id="demo1" width="100px" height=100px">
                    <p id="demoText"></p>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="real_name" lay-verify="required" placeholder="请输入店主姓名" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">店铺简介</label>
                <div class="layui-input-block">
                    <input type="text" name="info" lay-verify="required" placeholder="请输入店铺账号" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">店主电话</label>
                <div class="layui-input-block">
                    <input type="text" name="phone" lay-verify="number" placeholder="请输入店主电话" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline" id="city-div">
                    ...
                    <div class="layui-input-inline">
                        <select name="county" lay-verify="required"  lay-filter='county' id="county">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="address" lay-verify="required" placeholder="请选择自提点地址" class="layui-input address">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">经度</label>
                <div class="layui-input-block">
                    <input type="text" name="longitude" lay-verify="number" placeholder="请输入经度,最多保存6为小数" class="layui-input jingdu">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="latitude" lay-verify="number" placeholder="请输入纬度,最多保存6为小数" class="layui-input weidu">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">客服电话</label>
                <div class="layui-input-block">
                    <input type="text" name="customer_service" lay-verify="number" placeholder="请输入客服电话" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="sort" value="0" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
