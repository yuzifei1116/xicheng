    ...
    <div style="margin-left: 80px;margin-right: 100px">
        <form class="layui-form" action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="account" value="{$merchant.account}" lay-verify="required" placeholder="请输入店铺账号" class="layui-input" {if condition="$merchant.account!=''"}disabled{/if}>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">密码</label>
                <div class="layui-input-block">
                    <input type="password" name="pwd" lay-verify="pass" placeholder="请输入店铺密码,6~12位,不填则不修改密码" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="info" value="{$merchant.info}" lay-verify="required" placeholder="请输入店铺简介" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
<!--            </div>-->
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">商铺等级：</label>
                <div class="layui-input-inline">
                    <select name="grade" lay-filter='grade'>
                        {volist name="merchant_grade" id="vo"}
                        <option value="{$key}" {if condition="$merchant['grade']==$key"} selected {/if}>{$vo}</option>
                        {/volist}
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">商品是否需要审核</label>
                <div class="layui-input-block">
                    <input type="radio" name="product_examine" value="1" title="是" {if condition="$merchant.product_examine==1"} checked="" {/if}>
                    <input type="radio" name="product_examine" value="0" title="否" {if condition="$merchant.product_examine==0"} checked="" {/if}>
                </div>
            </div>
