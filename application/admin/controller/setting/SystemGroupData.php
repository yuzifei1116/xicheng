        ...
        foreach ($Fields["fields"] as $key => $value) {
            ...
            switch ($value["type"]){
                ...
                case 'select':
                    ...
                    break;
                case 'upload':
                    $f[] = Form::frameImageOne($value["title"],$value["name"],Url::build('admin/widget.images/index',array('fodder'=>$value["title"],'big'=>1)))->width('100%')->height('500px')->icon('image');
                    break;
                case 'uploads':
...
//                    if($param == "" || count($param) == 0)
    ...
    public function edit($gid,$id)
    {
            ...
            switch ($value['type']){
                ...
                case 'radio':
                 ...
                 case 'upload':
                     ...
                     $f[] = Form::frameImageOne($value['title'],$value['name'],Url::build('admin/widget.images/index',array('fodder'=>$value['title'],'big'=>1)),$image)->width('100%')->height('500px')->icon('image');
                    break;
                 case 'uploads':
        ...
        $f[] = Form::radio('status','状态',$GroupData["status"])->options([['value'=>1,'label'=>'开启'],['value'=>2,'label'=>'关闭']]);
