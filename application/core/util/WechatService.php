...
//                'notify_url'=>Request::instance()->domain().Url::build('wap/Wechat/notify'), //wap
                'notify_url'=>Request::instance()->domain().Url::build('gzh/notify/notify',['notify_type'=>'weixingzh']), //gzh
