    ...
    public static function getBargainUserStatusSuccess(){
        ...
        if($bargainUser) {
            foreach ($bargainUser as $k=>$v) {
                $bargainUser[$k]['avatar'] = User::where('uid',$v['uid'])->value('avatar');
            ...
            $bargainUser[0]['avatar'] = 'http://thirdwx.qlogo.cn/mmopen/ajNVdqHZLLCx03Y4hkSeVgQZGZLYDSQz6SZ7PDDNSLj3RxVPYqibMvW4cIOicPSSmA0xbrL9DY2RkunA1pulAs9g/132';
            $bargainUser[0]['info'] = '砍价上线了，快邀请您的好友来砍价';
        }
        return $bargainUser;
    }
}