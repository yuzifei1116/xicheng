...
use app\seller\model\system\SystemConfigTab as ConfigTabModel;
...
//                if($v['upload_type'] == 1 || $v['upload_type'] == 3) $list[$k]['value'] = explode(',',$v['value']);
   ...
   public function create(){
       $form = Form::create(Url::build('save'),[
           ...
           Form::frameInputOne('icon','图标',Url::build('seller/widget.widgets/icon',array('fodder'=>'icon')))->icon('ionic'),
   ...
   public function edit($id){
       ...
       $form = Form::create(Url::build('update',array('id'=>$id)),[
           ...
           Form::frameInputOne('icon','图标',Url::build('seller/widget.widgets/icon',array('fodder'=>'icon')),$menu['icon'])->icon('ionic'),
