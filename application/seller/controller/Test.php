...
use app\seller\model\user\UserExtract as UserExtractModel;//分销
use app\seller\model\user\User as UserModel;//用户
use app\seller\model\store\StoreProductReply as StoreProductReplyModel;//评论
use app\seller\model\store\StoreProduct as ProductModel;//产品
...
//        return $this->fetch('public/common_form');
    ...
    {
        //获取当前登录后台的管理员信息
        $sellerInfo = $this->sellerInfo->toArray();
        $roles  = explode(',',$sellerInfo['roles']);
