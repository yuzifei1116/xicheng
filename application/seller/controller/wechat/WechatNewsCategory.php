...
use app\seller\model\article\Article;
use service\FormBuilder as Form;
use service\JsonService;
use service\UtilService as Util;
use service\JsonService as Json;
use app\seller\model\wechat\WechatReply;
...
use \app\seller\model\wechat\WechatNewsCategory as WechatNewsCategoryModel;
use app\seller\model\article\Article as ArticleModel;
/**
 * 图文信息
 * Class WechatNewsCategory
 * @package app\seller\controller\wechat
 *
 */
    ...
    public function append(){
        $this->assign('list',[
            [
                'id'=>0,
                'title'=>'',
                'author'=>$this->sellerInfo->real_name,
                'content'=>'',
        ...
        $this->assign('id',0);
        $this->assign('author',$this->sellerInfo->real_name);
        return $this->fetch();
    }
