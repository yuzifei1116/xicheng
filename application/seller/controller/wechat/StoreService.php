...
use think\Request;
use think\Url;
use app\seller\model\wechat\StoreService as ServiceModel;
use app\seller\model\wechat\StoreServiceLog as StoreServiceLog;
...
class StoreService extends AuthController
{
    ...
    public function edit($id)
    {
        ...
        $f = array();
        $f[] = Form::frameImageOne('avatar','客服头像',Url::build('seller/widget.images/index',array('fodder'=>'avatar')),$service['avatar'])->icon('image');
