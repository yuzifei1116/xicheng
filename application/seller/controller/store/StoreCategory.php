...
class StoreCategory extends AuthController
{
    ...
    public function create()
    {
        $field = [
            ...
            Form::frameImageOne('pic','分类图标',Url::build('seller/widget.images/index',array('fodder'=>'pic')))->width('100%')->height('500px')->icon('image'),
            Form::number('sort','排序'),
...
//                $list = (Util::sortListTier(CategoryModel::where('id','<>',$id)->select()->toArray(),'顶级','pid','cate_name'));
            ...
            Form::frameImageOne('pic','分类图标',Url::build('seller/widget.images/index',array('fodder'=>'pic')),$c->getData('pic'))->width('100%')->height('500px')->icon('image'),
