...
use app\seller\model\system\SystemFile as SystemFileModel;
...
//   dump($fileAll);
    ...
    public function ceshi(){
        ...
        $form = Form::create('/save.php',[
            ...
            ,Form::frame('frame','frame','/seller/system.system_attachment/index.html?fodder=frame')
            ,Form::frameInputs('frameInputs','frameInputs','/seller/system.system_attachment/index.html?fodder=frameInputs')
            ,Form::frameFiles('month1','frameFiles','/seller/system.system_attachment/index.html?fodder=month1')
            ,Form::frameImages('fodder1','frameImages','/seller/system.system_attachment/index.html?fodder=fodder1')->maxLength(3)->width('800px')->height('400px')
            ,Form::frameImages('fodder11','frameImages','/seller/system.system_attachment/index.html?fodder=fodder11')->icon('images')
            ,Form::frameInputOne('month3','frameInputOne','/seller/system.system_attachment/index.html?fodder=month3')->icon('ionic')
            ,Form::frameFileOne('month4','frameFileOne','/seller/system.system_attachment/index.html?fodder=month4')
            ,Form::frameImageOne('month5','frameImageOne','/seller/system.system_attachment/index.html?fodder=month5')->icon('image')
