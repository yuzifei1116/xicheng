...
namespace app\seller\controller\article;
...
use think\Request;
use think\Url;
use app\seller\model\article\ArticleCategory as ArticleCategoryModel;
use app\seller\model\article\Article as ArticleModel;
...
//        })->multiple(1)->filterable(1);
        $f[] = Form::frameImageOne('image','分类图片',Url::build('seller/widget.images/index',array('fodder'=>'image')))->icon('image');
...
//            return $options;
//        })->multiple(1)->filterable(1);
        $f[] = Form::frameImageOne('image','分类图片',Url::build('seller/widget.images/index',array('fodder'=>'image')),$article['image'])->icon('image');
        $f[] = Form::number('sort','排序',0);
