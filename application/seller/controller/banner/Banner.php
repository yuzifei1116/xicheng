...
namespace app\seller\controller\banner;
...
use think\Request;
use app\seller\model\banner\Banner as BannerModel;
use think\Url;
...
class Banner extends AuthController
{
    ...
    public function banner_list(){
        return JsonService::successlayui(bannerModel::BannerList());
    }
    /**
     * 设置单个产品上架|下架
     *
    ...
    public function set_show($is_show='',$id=''){
        ...
        $res=BannerModel::where(['id'=>$id])->update(['is_show'=>(int)$is_show]);
        if($res){
