            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-container">
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}')">添加轮播图</button>
                    ...
                    <!--背景色-->
                    <script type="text/html" id="col">
                        <div class="layui-inline" style="background-color: {{d.bg_color}}">
...
<script>
    ...
    layList.tableList('List',"{:Url('banner_list')}",function (){
        return [
            ...
            {field: 'bg_color', title: '背景色',templet:'#col',width:'10%'},
