...
<form class="layui-form" action="" style="width: 80%;margin-left: 5%">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" lay-verify="required" name="title" placeholder="请输入活动标题" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="use_score" lay-verify="number" class="layui-input" value="1">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="prize_num" lay-verify="number" class="layui-input" value="1">
        </div>
    ...
    <div class="layui-inline" style="width: 100%">
        ...
        <div class="layui-input-inline" style="width: 40%">
            <input name="time" type="text" class="layui-input" id="test10" placeholder=" - " width="300px">
        </div>
    </div>
