...
<!--                               <span class="block m-t-xs"><strong class="font-bold">商铺:{$_Seller['mer_name']}</strong></span>-->
                                <span class="text-muted text-xs block"><strong class="font-bold">{$role_name}:{$_Seller['mer_name']}</strong><b class="caret"></b></span>
                            </span>
                        </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem admin_close" href="{:Url('setting.systemAdmin/adminInfo')}">个人资料</a>
                            </li>
                            <li><a class="admin_close" target="_blank" href="">联系我们</a>
                            </li>
                            <li class="divider"></li>
