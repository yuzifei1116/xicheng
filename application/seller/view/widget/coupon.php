...
<!--        </div>-->
        <div class="imagesbox">
            ...
            <div class="image-item">
                ...
                <img class="pic" src="{$vo.image|ltrim='.'}" id="{$vo.id}"/>
                {/if}
                <div style="padding-top: 10px;">ID：{$vo.id}</div>
                <div style="height: 55px;overflow: hidden;">{$vo.title}</div>
...
<!--            <button class="layui-btn layui-btn-sm"  id="upload">上传图片</button>-->
            <button class="layui-btn layui-btn-normal layui-btn-sm" id="ConfirmChoices">使用选中的优惠券</button>
...
<script src="{__MODULE_PATH}widget/coupon.js"></script>
