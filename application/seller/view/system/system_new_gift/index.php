            ...
            <div class="layui-input-block">
                <ul id="coupon_li" class="layui-row">
                    ...
                    <li>
                        ...
                        <div class="layui-col-sm4"><label class="layui-form-label">数量:</label><input type="number" name="num[]" value="{$vo.num}" class="layui-input" style="width:20%;"></div>
                        <div class="layui-col-sm2"><button class="layui-btn layui-btn-danger layui-btn-md del">删除</button></div><hr>
    ...
    layui.use(['form','laydate','upload'], function(){
        ...
        form.on('select(select_filter)', function(data){
            ...
            if (cids.indexOf(cid) == -1){
                ...
                var num = '<label class="layui-form-label">数量:</label><input type="number" name="num[]" value="1" class="layui-input" style="width:20%;">';
                var btn = '<button class="layui-btn layui-btn-danger layui-btn-md del">删除</button>';
                var item = '<li>'+
