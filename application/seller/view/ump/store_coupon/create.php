...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item coupon_type">
        ...
        <div class="layui-input-inline">
            <input type="radio" name="coupon_type" value="1" title="代金券" checked="">
            <input type="radio" name="coupon_type" value="2" title="折扣券">
        </div>
    </div>
    <div class="layui-form-item coupon_price">
        <label class="layui-form-label" >优惠券面值</label>
        <div class="layui-input-inline"  style="width: 10%">
            <input type="text" name="coupon_price" value="1" lay-verify="number" class="layui-input" placeholder="例:100">
        </div>
    </div>
<!--    <div class="layui-form-item coupon_discount" style="display: none">-->
<!--        <label class="layui-form-label" >折扣率</label>-->
<!--        <div class="layui-input-inline" style="width: 10%">-->
<!--            <input type="text" name="coupon_discount" lay-verify="number" placeholder="0~1" value="1" class="layui-input">-->
<!--        </div>-->
<!--        <div class="layui-form-mid layui-word-aux">0-1之间的两位小数,例:0.50 是5折</div>-->
<!--    </div>-->
    <div class="layui-form-item coupon_discount" style="display: none">
        <label class="layui-form-label" >折扣率</label>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" id="xl">
            <input type="radio" name="is_limit" value="0" title="不限量" checked="">
            <input type="radio" name="is_limit" value="1" title="限量" id="xl">
        </div>
    </div>
    <div class="layui-form-item coupon_num" style="display: none">
        <label class="layui-form-label" >优惠券数量</label>
        <div class="layui-input-inline"  style="width: 10%">
            <input type="text" name="coupon_num" lay-verify="number" value="0" class="layui-input" placeholder="0">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label" >用户前台可否领取</label>
        <div class="layui-input-inline self_can_get">
            <input type="radio" name="self_can_get" value="1" title="可以" checked="">
            <input type="radio" name="self_can_get" value="0" title="不可以">
        </div>
        <div class="layui-form-mid layui-word-aux">是否可以让用户自己在页面领取。选不可以，则只能后台发放给用户</div>

    </div>
    <div class="layui-form-item self_max_num">
        <label class="layui-form-label" >每人最多可领取几次</label>
        <div class="layui-input-inline"  style="width: 10%">
            <input type="text" name="self_max_num" value="1" lay-verify="required|number" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" >
            <input type="text" name="use_min_price" value="0" lay-verify="required|number" class="layui-input" placeholder="1">
        </div>
...
<!--        <div class="layui-input-inline" >-->
<!--            <input type="text" name="coupon_products" class="layui-input">-->
<!--        </div>-->
    ...
    <div class="layui-form-item">
        <div class="layui-input-block" >
            ...
            <span style="color: red">不选则全部商品都可以使用</span>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label" >优惠券持续时间</label>
        <div class="layui-input-inline time_type">
            <input type="radio" name="time_type" value="1" title="天数" checked="">
            <input type="radio" name="time_type" value="2" title="期限">
        </div>
    </div>
    <div class="layui-form-item coupon_long_time">
        <label class="layui-form-label" >有效天数</label>
        <div class="layui-input-inline"  style="width: 10%">
            <input type="text" name="coupon_long_time" value="0" lay-verify="number" class="layui-input">
        </div>
    ...
    <div class="layui-form-item time" style="display: none">
        ...
        <div class="layui-input-inline">
            <input type="text" name="time" readonly class="layui-input" id="test7" placeholder=" - ">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline"  style="width: 10%">
            <input type="text" name="sort" lay-verify="number" class="layui-input" value="0">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="radio" name="status" value="2" title="过期">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
