...
//    setTime();
    function setTime() {
        setTimeout(function () {
            $eb.axios.get("{:Url('get_combination_id')}").then(function(res){
...
//            {field: 'ot_price', title: '原价',width:'6%'},
            ...
            {field: 'start_name', title: '拼团状态',width:'8%',toolbar:"#statusCn"},
            {field: 'start_time', title: '拼团开始时间', width: '13%'},
            {field: 'stop_time', title: '拼团结束时间', width: '13%'},
    ...
    layList.search('export',function(where){
        location.href=layList.U({c:'ump.store_combination',a:'save_excel',q:{status:where.status,store_name:where.store_name}});
    })
