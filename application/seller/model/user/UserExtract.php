...
class UserExtract extends ModelBasic
{
    ...
    public static function changeFail($id,$fail_msg)
    {
        ...
        UserBill::income('提现失败',$uid,'now_money_spread','extract',$extract_number,$id,bcadd($User['now_money_spread'],$extract_number,2),$mark);
        User::bcInc($uid,'now_money_spread',$extract_number,'uid');
