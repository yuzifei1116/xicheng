...
//        dump(self::getLastSql());die;
    ...
    public static function backOrderBrokerage($orderInfo)
    {
        ...
        self::beginTrans();
        $res1 = UserBill::income('获得推广佣金',$userInfo['spread_uid'],'now_money_spread','brokerage',$brokeragePrice,$orderInfo['id'],0,$mark);
    ...
    public static function backOrderBrokerageTwo($orderInfo){
        ...
        self::beginTrans();
        $res1 = UserBill::income('获得推广佣金',$userInfoTwo['spread_uid'],'now_money_spread','brokerage',$brokeragePrice,$orderInfo['id'],0,$mark);
