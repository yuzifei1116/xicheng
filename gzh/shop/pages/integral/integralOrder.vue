		...
		<form @submit="formSubmit" @reset="formReset">
			...
			<view class="goods-section">
				...
				<!-- <view v-for="(item,index) in cartInfo" :key="index"> -->
					<view class="g-item">
						<image :src="indexUrl(cartInfo.image)"></image>
						<view class="right">
							<text class="title clamp">{{cartInfo.store_name}}</text>
							<!-- <text class="spec">{{cartInfo.productInfo.attrInfo?item.productInfo.attrInfo.suk :''}}</text> -->
							<view class="price-box">
								<text class="price">{{cartInfo.integral}}积分</text>
			...
			<!-- 优惠明细 -->
		<!-- 	<view class="yt-list" v-if="confirmOrder.seckill_id <= 0">
			...
			<view class="yt-list">
				<view class="yt-list-cell b-b">
					<text class="cell-tit clamp">我的积分</text>
					<text class="cell-tip ">{{integral}}积分</text>
				</view>
				<view class="yt-list-cell b-b">
					<text class="cell-tit clamp">商品金额</text>
					<text class="cell-tip red">{{cartInfo.integral}}积分</text>
				</view>
 ...
 -->
			...
			<view class="footer">
				<view class="price-content">
					...
					<text class=" price-tip price">{{isTotal}}积分</text>
				</view>
				<view>
...
<script>
	export default {
		...
		methods: {
			confirm_order() {
				let self = this;
				let path = '/gzh/shop_api/product_detail'
				let data = {
					id: self.id,
					// num:self.num
				}
