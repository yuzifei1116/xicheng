<template>
	<view>
		...
		<view class="footer acea-row-reverse" v-else-if="cartInfo._status._type == 2">
			<view>
				<button class="submit" form-type="submit" @click="orderCon()">确认收货</button>
			</view>
		</view>

		<view class="footer acea-row-reverse" v-else-if="cartInfo.status == 0  &&cartInfo.seckill_id == 0 && cartInfo.combination_id == 0 && cartInfo.presale_id == 0">
			<view>
		...
		<view class="footer acea-row-reverse" v-else-if="cartInfo._status._type == 4">
			<!-- <view>
		...
		<view class="footer acea-row-reverse" v-if="cartInfo.paid == 0 && cartInfo.presale_id > 0">
			<view >
