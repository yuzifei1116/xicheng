	...
	<view class="container">
		...
		<view class="time aces-space-between">
			...
			<view class="time-s" v-if="isClickBtn">
				<view class="time-tit">距秒杀结束仅剩</view>
				{{when_sold}} 
			</view>
		...
		>
			...
			<view class="layer attr-content" @click.stop="stopPrevent">
				...
				<view class="acea-row cnum">
					...
					<text v-else>
						<view class="clnum clnumr aa" :class="{onnumr:num >= storeInfo.num}" @click="addNum">+</view>
					</text>
				</view>
...
<script>
	...
	export default{
		...
		methods:{
			...
			details(){
				let self = this;
				let path = '/gzh/seckill_api/seckill_detail?id='+self.detid
